...
def make_parser_input(ocr_lines):
    return [{"text": line} for line in ocr_lines]
...
def evaluate_records(records, parse_menu_lines):
    ...
    for record in records:
        ...
        pred_items = parse_menu_lines(make_parser_input(record["ocr_lines"]))
...
def main(input_path, out_dir, split_name, parser_module):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="reports/parser_baseline_v2")
    parser.add_argument("--split_name", type=str, default="test")
    parser.add_argument("--parser_module", type=str, default="menu_structuring_baseline_v2")
